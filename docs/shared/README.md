...
- [Evidence and escalation](evidence-and-escalation.md)
- [L1 dependency sweeper](l1-dependency-sweeper.md)
- [Live delivery log](live-delivery-log.md)

If a command, path, package manager, sandbox, keychain, or filesystem behavior is platform-specific, place it in the matching OS lane instead.
